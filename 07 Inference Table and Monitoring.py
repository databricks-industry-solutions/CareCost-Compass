...
# MAGIC %pip install textstat==0.7.3 tiktoken==0.5.1 evaluate==0.4.1 transformers==4.30.2 torch==1.13.1 databricks-sdk>=0.28.0
...
checkpoint_location = f"dbfs:/payload-logging/{endpoint_name}/checkpoint"
...
INPUT_REQUEST_JSON_PATH = "messages"
...
OUTPUT_REQUEST_JSON_PATH = "content"
...
def unpack_requests(requests_raw: DataFrame, 
    ...
    # # Unpack JSON.
    # requests_unpacked = requests_success#(requests_success
...
requests_processed = unpack_requests(requests_raw, INPUT_REQUEST_JSON_PATH, INPUT_JSON_PATH_TYPE, OUTPUT_REQUEST_JSON_PATH, OUPUT_JSON_PATH_TYPE)
